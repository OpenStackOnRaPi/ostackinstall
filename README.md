...
In either case, starting the cluster RPis can be forced by accessing the TP-Link switch dashboard and restarting the switch using the `System->Reboot` option (powering on PoE ports switches on RPi boards).
