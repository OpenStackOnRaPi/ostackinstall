...
5. Virtualization
   * Currently, we use qemu emulation as we have not managed to get KVM working on Raspberry Pi under Kolla-Ansible OpenStack. This may change in the future.
7. Notes
