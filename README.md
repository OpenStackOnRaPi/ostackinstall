...
5. Notes
   ...
   * in this guide, we'll assume a cluster setup consisting of a TP-Link switch and a Linksys router, and we'll use those names in the text; map those names to your setup if you're using different hardware
