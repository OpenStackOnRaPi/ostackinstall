...
This section describes the first of the two steps mentioned (setting flat provider network). The second step (actually enabling and using VLAN provider networks) is covered in section [LAN provider networks - part 2][#vlan-provider-networks---part -2-enabling-and-using-vlan-provider-networks].
