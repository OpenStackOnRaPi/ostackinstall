...
> [!Note]
> To access RPis using WiFi you have to enable WiFi on the boards in your netplan file - see the description contained in [this section](README.md#configuring-the-network-flat).
