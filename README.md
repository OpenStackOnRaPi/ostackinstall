...
This guide assumes a specific network hardware configuration in your cluster. However, it should also be applicable to other network hardware provided it supports the required network constructs (e.g., VLAN networks).
